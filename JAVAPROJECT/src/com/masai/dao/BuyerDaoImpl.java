...
public class BuyerDaoImpl implements BuyerDao{
	...
	try {
		PreparedStatement	ps=conn.prepareStatement("insert into buyerproduct(bid,spno,buydate,bpcategory) values(?,?,?,?,?)");
	
		ps.setInt(1, bp.getBpno());
		ps.setInt(2,bp.getSpno());
		ps.setDate(3, bp.getBuydate());
		ps.setString(4, bp.getBpcategory());
